...
const PopularVoyageCard = ({ voyage, onPress }: VoyageCardProps) => {
  ...
  const handlePress = () => {
    if (onPress) {
      ...
      console.log("go de voyage description");
    ...
    >
      ...
      <View style={styles.footer}>
        <View style={styles.priceContainer}>
          ...
          <Text style={styles.priceText}>{voyage.price} XOF</Text>
        </View>
...
export default PopularVoyageCard;
